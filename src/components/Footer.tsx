...
function Footer() {
  return (
    <footer className="footer">
      <div className="footer__container d-flex w-100 flex-row align-items-start justify-content-center">
        <div className="footer__address text--light">
          <p>Jalan Suroyo No. 161 Mayangan Kota Probolonggo 672000</p>
          <p>binarcarrental@gmail.com</p>
          <p>081-233-334-808</p>
        </div>
        <div className="text--regular d-flex flex-column gap-3">
          <a className="nav-link" href="#">Our Services</a>
          <a className="nav-link" href="#">Why Us</a>
          <a className="nav-link" href="#">Testimonial</a>
          <a className="nav-link" href="#">FAQ</a>      </div>
        <div>
        ...
        <div>
          ...
          <a className="footer__brand navbar-brand bg--primary text--primary" href="#">CARRENT.CO</a>
        </div>
      </div>
    </footer>
  )
